...
ActiveRecord::Schema[8.0].define(version: 2026_06_20_120001) do
  ...
  create_table "chat_messages", force: :cascade do |t|
    ...
    t.index ["trip_id", "created_at"], name: "index_chat_messages_on_trip_id_and_created_at"
    t.index ["trip_id"], name: "index_chat_messages_on_trip_id"
  end
  ...
  create_table "itineraries", force: :cascade do |t|
    ...
    t.index ["trip_id"], name: "index_itineraries_trip_id_unique", unique: true
  end
  ...
  create_table "trips", force: :cascade do |t|
    ...
    t.decimal "accommodation_latitude", precision: 10, scale: 6
    t.decimal "accommodation_longitude", precision: 10, scale: 6
  ...
  add_foreign_key "chat_messages", "trips"
